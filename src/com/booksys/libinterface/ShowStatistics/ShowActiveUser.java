...
public class ShowActiveUser extends JFrame {
    int i = 0;

    public ShowActiveUser(ResultSet result) throws SQLException {
        //设置窗口
        super("排行榜");
        ...
        //设置标签
        JLabel label = new JLabel("读者借阅排行榜");
